  ...
  return (
    <nav className="admin-mobile-nav">
      ...
      <div className="admin-mobile-nav__links">
        <Link
          href="/admin"
          className={`admin-mobile-nav__link ${isActive('/admin') && !isActive('/admin/komisi') && !isActive('/admin/laporan') && !isActive('/admin/user') ? 'admin-mobile-nav__link--active' : ''}`}
        >
        ...
        <Link
          href="/admin/user"
          className={`admin-mobile-nav__link ${isActive('/admin/user') ? 'admin-mobile-nav__link--active' : ''}`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
